...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let lovelyCover = DeveloperToolsSupport.ImageResource(name: "LovelyCover", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    static var launchIcon: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .launchIcon)
#else
        .init()
#endif
    }

    /// The "LovelyCover" asset catalog image.
    static var lovelyCover: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .lovelyCover)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "LaunchIcon" asset catalog image.
    static var launchIcon: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .launchIcon)
#else
        .init()
    ...
    /// The "LovelyCover" asset catalog image.
    static var lovelyCover: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .lovelyCover)
#else
        .init()
