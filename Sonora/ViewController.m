...
- (void)setupTabs {
    SonoraMusicViewController *musicVC = [[SonoraMusicViewController alloc] init];
...
- (void)animateMiniPlayerAlongNavigationTransition:(UINavigationController *)navigationController {
    ...
    BOOL hasTrack = (SonoraPlaybackManager.sharedManager.currentTrack != nil);
...
- (void)updateMiniPlayer {
    ...
    BOOL canStep = (playback.currentQueue.count > 1) || playback.isShuffleEnabled || (playback.repeatMode != SonoraRepeatModeNone);
